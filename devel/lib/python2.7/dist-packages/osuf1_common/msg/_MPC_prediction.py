...
"""autogenerated by genpy from osuf1_common/MPC_prediction.msg. Do not edit."""
import codecs
import sys
...
class MPC_prediction(genpy.Message):
  _md5sum = "18f71d97ec5d2c12b5676c1814e14a05"
  _type = "osuf1_common/MPC_prediction"
...
float32[] inputs"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MPC_prediction, self).__init__(*args, **kwds)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.inputs = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
