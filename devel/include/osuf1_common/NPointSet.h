...
struct NPointSet_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::osuf1_common::NPoint_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::osuf1_common::NPoint_<ContainerAllocator> >::other >  _set_type;
  _set_type set;
